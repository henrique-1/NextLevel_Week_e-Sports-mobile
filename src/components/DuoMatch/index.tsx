...
import { View, Modal, ModalProps, Text, TouchableOpacity, Alert, ActivityIndicator, ToastAndroid } from 'react-native';
...
export function DuoMatch({ discord, onClose, ...rest }: Props) {
    ...
    async function handleCopyDiscordToClipboard() {
        ...
        ToastAndroid.show("Usuário copiado para a área de transferência!", ToastAndroid.CENTER)
        setIsCopping(false);
    }
